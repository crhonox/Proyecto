...
{
  echo '<script> window.location="inicioperfilusuario.php" </script>';
}
?>
<!DOCTYPE html>
...
<link href="layout/styles/framework.css" rel="stylesheet" type="text/css" media="all">
        <SCRIPT Language=Javascript SRC="validaUser.js"></SCRIPT>
        <SCRIPT Language=Javascript SRC="validarRut.js"></SCRIPT>
</head>
<body id="top">
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
...
<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/01.png')">
  ...
  <div id="breadcrumb" class="hoc clear">
    ...
    <ul>
      ...
      <li><a href="registroUsuario.php">Registro de Usuarios</a></li>
    </ul>
    <!-- ################################################################################################ -->
  </div>
</div>
...
<div class="wrapper row3">
  <main class="hoc container clear">
    ...
    <div class="content">
      <!-- Codigo Body Aqui -->
      <form  action="registroUsuarioNormal.php" method="post" onsubmit="return valida()">
        <h2> Crear Cuenta</h2>
        <div id="comments">

              <div class="one_third first">
                <input type="text"  placeholder="Nombre*" id="nombre" name="nombre" size="22"><br/>
              </div>
                <div class="one_third">
                  <input type="text"  placeholder="Apellido*" id="apellido" name="apellido" size="22"><br/>
                </div>
                <div class="one_third">
                <input  type="text" id="edad" placeholder="Edad*" name="edad" size="22"><br/>
              </div>
                <div class="one_third first">
                <input  type="password"  placeholder="Contraseña*" id="upass" name="upass" size="22"><br/>
              </div>
                <div class="one_third">
                <input type="password"  placeholder="Confirmar Contraseña*" id="cpass" name="cpass" size="22"><br/>
              </div>
                <div class="one_third">
                <input type="email"  placeholder="Correo Electronico*" id="umail" name="umail"><br/>
              </div>
                <div class="one_third first">
                <input type="text" id="rut" placeholder="Rut" oninput="checkRut(this)" name="rut"><br/>
              </div>
                <div class="one_quarter">
                  ...
                  <div class="one_third first">
                    <button class="btn btn-primary" type="submit" name="btnRegistrar"> Registrarse </button>
                    <button class="btn btn-primary" type="reset" name="btnCancelar"> Cancelar </button>
                  </div>
