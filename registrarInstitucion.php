...
<div class="wrapper row3">
  <main class="hoc container clear">
    ...
    <!-- ################################################################################################ -->
    <div class="content">
      <form action="registroInti.php" method="post" onsubmit="return validar();">
    <h2> Crear Cuenta Institucional</h2>
    <div id="comments">
        <div class="one_third first">
        <input  type="text" id="nombre" name="nombre" placeholder="Nombre de Institución" size="22"  ><br/>
        </div>
        <div class="one_third">
        <input  type="email" id="mail" name="mail" placeholder="E-Mail" size="22" ><br/>
      </div>
        <div class="one_third">
        <input   type="password" id="pass" name="pass" placeholder="Contraseña" size="22"  ><br/>
      </div>
        <div class="one_third first">
        <input   type="password"  id="passConfirm" name="passConfirm" placeholder="Confirme Contraseña" size="22" ><br/>
      </div>
        <div class="one_third">
        <select id="tipo_Institucion" name="tipo_Institucion" ><br/>
        <option value="lucro" selected>---Seleccione Opción---</option>
        <option value="lucro">Con fin de Lucro</option>
        <option value="no_lucro">Sin fin de Lucro</option>
        </select><br/>
      </div>
        <div class="one_quarter">
        <select id="pais_insti"name="pais_insti">
            <option value="NULL" selected>---Seleccione Opción---</option>
          ...
          <div class="one_third first">
          <button class="btn btn-primary" type="submit" value="Resgistrar" class="btn-enviar">Registrar</button>
          <button class="btn btn-primary" type="reset" name="btnCancelar">Limpiar</button>
          </div>
      </div>
    </form>
