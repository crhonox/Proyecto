...
if (isset($_POST['from']))
{
    ...
    if ($_POST['from']!="" AND $_POST['to']!="")
    {
        ...
        $im=$connect->query("SELECT MAX(id) AS id FROM eventos");
        $row = $im->fetch_row();
        $id = trim($row[0]);

        // para generar el link del evento
        $link = "$base_url"."descripcion_eventousu.php?id=$id";
        ...
        header("Location:http://127.0.0.1/Limpio2/calendarioUsu.php");
    }
}
...
<head>
        ...
        <link rel="stylesheet" href="style/menuperfil.css">
      ...
      <div class="modal-body">
        <form action="" method="post">
                    ...
                    <select class="form-control" name="class" id="tipo">
                        ...
                        <option value="event-success">Postulacion</option>
